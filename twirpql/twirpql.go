...
import (
	...
	"github.com/metatexx/protoc-gen-twirpql/internal/genenums"
	"github.com/metatexx/protoc-gen-twirpql/internal/genresolver"
	"github.com/metatexx/protoc-gen-twirpql/internal/genscalar"
	"github.com/metatexx/protoc-gen-twirpql/internal/genserver"
	"github.com/metatexx/protoc-gen-twirpql/internal/genunions"
	"github.com/metatexx/protoc-gen-twirpql/internal/gqlfmt"
	"github.com/metatexx/protoc-gen-twirpql/options"
	"gopkg.in/yaml.v2"
)
...
func (tql *twirpql) touchConfig(out io.Writer) {
	...
	cfg.Exec = gqlconfig.ExecConfig{Filename: tql.path("generated.go")}
